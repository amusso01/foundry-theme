...
$head = $headArray['headline'];
$preHead = $headArray['pre_headline'];
$subHead = $headArray['sub_headline'];
$ctaHead = $headArray['headline_cta'];
...
<div class="container-fluid services-wrapper">
	...
	<div class="container">
		...
		data-aos-offset = "100"
		class="row headline first_home_section">
			<div class="col-md-7">
	...
	<section data-aos="fade-up"  
		data-aos-duration="700" 
		data-aos-offset = "100"
		data-aos-anchor-placement="top-bottom" class="create home__services">
		<div class="container">
			<div class="row create__inner home__services-inner">
				<div  class="create__headline col-lg-5">
					...
					<div class="create__excerpt home__services-excerpt">
						...
						<a href="<?php echo site_url('/create') ?>">OVERVIEW</a>
					</div>
				</div>
		...
		data-aos-duration="700" 
		data-aos-offset = "100"
		data-aos-anchor-placement="top-bottom" class=" container-fluid create__relatedWorks home__relatedWorks">
					...
					<article class="<?php echo $postCat->slug; ?>">
						<div class="hovereffect">
							...
							<div class="overlay">
								...
								<p class="work-description info">READ CASE STUDY</p>
							</div>
						</div>
					</article>
				</a><!-- work-box-home -->
	...
	<section data-aos="fade-up"  
		data-aos-duration="700" 
		data-aos-offset = "100"
		data-aos-anchor-placement="top-bottom"  class="build home__services">
		<div class="container">
			<div class="row build__inner home__services-inner">
				<div class="build__headline col-lg-5">
					<div class="build__headline-svg home__services-svg">
						<div class="svg-service">
					...
					<div class="build__title home__services-title">
						<p>DEVELOPMENT SOLUTIONS</p>
						<h3 class="ultraWeight" >BUILD</h3>
					</div>
					<div class="build__excerpt home__services-excerpt">
						<p><?php echo $buildExcept ?></p>
						<a href="<?php echo site_url('/build') ?>">OVERVIEW</a>
					</div>
				</div>
				<div class="build__relatedServices home__services-relatedServices col-lg-7">
					<div class="services__grid">
					<?php foreach($buildServices as  $service) : ?>
							<div class="service__grid-single home__services-single">
								<a href="<?php echo $service['sub_service_link'] ?>">
									<div class="homeService__title">
										<h4><?php echo $service['sub_service_title'] ?></h4>
		...
		data-aos-duration="700" 
		data-aos-offset = "100"
		data-aos-anchor-placement="top-bottom" class=" container-fluid build__relatedWorks home__relatedWorks">
	...
	<section data-aos="fade-up"  
		data-aos-duration="700" 
		data-aos-offset = "100"
		data-aos-anchor-placement="top-bottom" class="promote home__services">
		<div class="container">
			<div class="row promote__inner home__services-inner">
				<div  class="promote__headline col-lg-5">
					<div class="promote__headline-svg home__services-svg">
						<div class="svg-service">
					...
					<div class="promote__title home__services-title">
						<p>ENGAGEMENT SOLUTIONS</p>
						<h3 class="ultraWeight" >PROMOTE</h3>
					</div>
					<div class="promote__excerpt home__services-excerpt">
						<p><?php echo $promoteExcept ?></p>
						<a href="<?php echo site_url('/promote') ?>">OVERVIEW</a>
					</div>
				</div>
				<div class="promote__relatedServices home__services-relatedServices col-lg-7">
					<div class="services__grid">
		...
		data-aos-offset = "100"
		data-aos-duration="700" 
		data-aos-anchor-placement="top-bottom" class=" container-fluid promote__relatedWorks home__relatedWorks">
		
			<div class="home-work-grid">
			<?php foreach($promoteWorks as $work) : ?>
			<?php	$post_id = $work['single_work']->ID;
			$link = get_the_permalink( $post_id);
			$thumbnail_id  = get_post_thumbnail_id($post_id);
			$thumbnail_alt = get_post_meta( $thumbnail_id, '_wp_attachment_image_alt', true );
	...
	<article data-aos="fade-up"  
		data-aos-duration="700" 
		data-aos-offset = "100"
		data-aos-anchor-placement="top-bottom" class="container brief">
<div class="row">
<div class="col-lg-6">
...
<div class="meet-team">
<a class="see-more" href="https://www.foundrydigital.co.uk/about/">ABOUT US <i class="fa fa-chevron-right"></i></a>
</div>
<div class="carousel-inner">
<div class="carousel-item">
<img class="d-block w-100" src="https://www.foundrydigital.co.uk/wp-content/uploads/2019/02/pexels-photo-935756-1.jpeg" alt="Creative Agency, Web Development, Foundry Digital">
</div>
<div class="carousel-item">
<img class="d-block w-100" src="https://www.foundrydigital.co.uk/wp-content/uploads/2019/02/pexels-photo-1181343.jpeg" alt="Creative Agency, Web Design, Web Development, Foundry Digital">
</div>
<div class="carousel-item active">
<img class="d-block w-100" src="https://www.foundrydigital.co.uk/wp-content/uploads/2019/02/pexels-photo-630839.jpeg" alt="Creative Agency, Web Design, Web Development, Foundry Digital">
</div>
</div>
</div>
</div>
...
<footer>
<a href="https://www.foundrydigital.co.uk/about/">DISCOVER MORE</a>
</footer>
</div>
</div>
</article>
