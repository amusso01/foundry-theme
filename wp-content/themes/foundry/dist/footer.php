...
?>
	...
	<div class="footerbanner" style="padding: 60px 0; border-bottom: 1px solid #C6C6C6">
		<div class="container">
			<center>
				<a href="https://www.fdry.com/service/build/woocommerce-agency/"><img style="display: inline-block;max-width: 210px;height: 85px;object-fit: contain;margin: 0 15px;" src="<?php echo get_template_directory_uri(); ?>/img/images/woologo.jpg" /></a>
				<a href="https://www.fdry.com/service/build/bigcommerce-agency/"><img style="display: inline-block;max-width: 210px;height: 85px;object-fit: contain;margin: 0 15px;" src="<?php echo get_template_directory_uri(); ?>/img/images/biglogo.jpg" /></a>
				<a href="https://www.fdry.com/service/build/shopify-agency/"><img style="display: inline-block;max-width: 170px;height: 85px;object-fit: contain;margin: 0 15px;" src="<?php echo get_template_directory_uri(); ?>/img/images/shologo.png" /></a>
			</center>
		</div>
	</div>
